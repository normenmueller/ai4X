...
This contract is the planning counterpart to the development session conformance check in `adm/gdl/dev/contracts/agent-conformance.md`.
...
- `adm/gdl/dev/contracts/agent-conformance.md` — Development session conformance (counterpart).
