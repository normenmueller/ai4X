...
session-hygiene-check:
	@echo '[ai4x] verify: checking session-hygiene Dhall projection'
	@node util/repository/session-hygiene/publish-projection.mjs --check

session-hygiene-test:
	@echo '[ai4x] verify: checking session-hygiene safety contract'
	@node --test util/repository/session-hygiene/*.test.mjs
