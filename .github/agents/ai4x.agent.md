...
- During planning, own the classification and routing action defined solely by `crp/gov/qlt/ai-strategy-quality.md`; do not reproduce or weaken that contract.
...
- Advance the AI-suitability gate only when it conforms to `crp/gov/qlt/ai-strategy-quality.md`.
